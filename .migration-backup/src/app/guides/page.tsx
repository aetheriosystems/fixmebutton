...
export const metadata: Metadata = {
  title: `All Guides — ${SITE_NAME}`,
  description: "Browse all step-by-step tech troubleshooting guides. Fix your smartphone, computer, TV, WiFi, and more.",
};
    ...
    <main className="max-w-5xl mx-auto px-4 py-12">
      <header className="mb-10">
        ...
        <p className="mt-2 text-lg text-gray-500">
          Step-by-step troubleshooting for every device in your life
        </p>
      </header>
      ...
      {guides.length === 0 ? (
        <div className="text-center py-20 text-gray-400">
          ...
          <p className="mt-2">Our team is writing the first batch of troubleshooting guides.</p>
        </div>
      ) : (
