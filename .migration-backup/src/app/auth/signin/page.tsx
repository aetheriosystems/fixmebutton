...
export default async function SignInPage({
  ...
  const errorMessages: Record<string, string> = {
    ...
    "verification-failed": "Verification failed. Please try signing up again.",
    "db-unavailable": "Our database is temporarily unavailable. Please try again later.",
    CredentialsSignin: "Invalid email or password. If you just signed up, check your email for the verification link.",
  };
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-20">
      ...
      {verified && (
        <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg text-sm text-green-700 text-center">
          ...
          <div className="space-y-3 mb-8">
            {hasGoogle && (
              ...
              >
                <button
                  type="submit"
                  className="w-full px-6 py-3 bg-white border border-gray-300 rounded-lg font-medium text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-center gap-3"
                >
            ...
            {hasGitHub && (
              ...
              >
                <button
                  type="submit"
                  className="w-full px-6 py-3 bg-gray-900 text-white rounded-lg font-medium hover:bg-gray-800 transition-colors flex items-center justify-center gap-3"
                >
