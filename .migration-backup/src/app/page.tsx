import { getAllGuides, getCategoryBySlug } from "@/lib/guides";
              ...
              return (
                ...
                >
                  ...
                  <div className="flex gap-2">
                    {guide.time_estimate && (
                      <span className="text-xs text-gray-400">⏱ {guide.time_estimate}</span>
                    )}
                    {guide.steps && (
                      <span className="text-xs text-gray-400">{guide.steps} steps</span>
                    )}
                  </div>
                </Link>
              );
          ...
          {[
            {
              ...
              desc: "Browse by device or search for your specific tech issue.",
              icon: "🔍",
            },
            {
              step: "2",
              title: "Follow the Steps",
              desc: "Clear, numbered instructions with pictures for every step.",
              icon: "📋",
            },
            {
              step: "3",
              title: "Problem Solved",
              desc: "Get back to what matters. No tech degree required.",
              icon: "✅",
            },
          ].map((item) => (
