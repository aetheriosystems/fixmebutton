    ...
    <main className="max-w-5xl mx-auto px-4 py-16">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-500 max-w-2xl mx-auto">
          Free guides are great. Premium gives you interactive step-by-step
          guidance, voice control, and an &ldquo;I&rsquo;m stuck&rdquo; button
          that actually helps.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        <div className="p-8 bg-white border border-gray-200 rounded-2xl">
          ...
          <Link
            href="/guides"
            className="block w-full py-3 text-center font-medium text-blue-600 border border-blue-600 rounded-lg hover:bg-blue-50 transition-colors"
          >
            Browse Free Guides
          </Link>
        </div>
        ...
        <div className="p-8 bg-gradient-to-b from-blue-600 to-blue-700 text-white rounded-2xl ring-4 ring-blue-200">
          <div className="flex justify-between items-start mb-1">
            ...
            <span className="px-2.5 py-1 bg-white/20 text-xs font-semibold rounded-full">
              BEST VALUE
            </span>
          </div>
      ...
      <div className="text-center mt-12">
        <p className="text-sm text-gray-400">
          ...
          <a href="mailto:hello@fixmebutton.com" className="text-blue-600 underline">
            Contact us
          </a>
        </p>
      </div>
